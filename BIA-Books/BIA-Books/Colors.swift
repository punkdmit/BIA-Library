...
struct BooksColor {
    static let textFieldBackground = UIColor(named: "AuthorizationColor") ?? UIColor()
    static let textPrimary = UIColor(named: "TextPrimary") ?? UIColor()
    static let logInStatusText = UIColor(named: "LogInStatusText") ?? UIColor()
    static let inactiveColor = UIColor(named: "EntryButtonText") ?? UIColor()
