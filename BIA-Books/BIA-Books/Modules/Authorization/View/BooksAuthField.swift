...
//
////    public var activeColor: UIColor = DLColor.Accent.brandPrimary.color
////    public var inactiveColor: UIColor = DLColor.Separator.textBorder.color
////    public var errorColor: UIColor = DLColor.Accent.error.color
////    public var primaryTextColor: UIColor = DLColor.Text.primary.color
////    public var secondaryTextColor: UIColor = DLColor.Text.secondary.color
//
...
////        self.tintColor = DLColor.Accent.brandPrimary.color
//    }
//
...
//                self.leadingAssistiveLabel.textColor = self.isError ? self.errorColor : self.secondaryTextColor
//                self.borderShapeLayer.strokeColor = self.isError ? self.errorColor.cgColor : self.activeColor.cgColor
////                self.textColor = DLColor.Text.primary.color
//
//            case .disabledEmpty:
//                self.label.transform = .identity
